...
## Paper Notes: Evaluating AGENTS.md â€” Are Repository-Level Context Files Helpful for Coding Agents?
...
- But no one had actually rigorously tested if they work â€” this paper does that
...
- AI-generated context files make things WORSE â€” success rate dropped by about 3% compared to having no context file at all
- Human-written context files help only a tiny bit â€” about 4% improvement on average
...
- Agents follow the instructions in context files very obediently â€” even when those instructions are unnecessary or bad
- Context files make agents do more exploration, more testing, and more thinking â€” much of it wasted effort
- The files often contain unnecessary requirements that distract the agent from the actual task
- An AI-generated context file might tell the agent "always run tests after changes" â€” the agent does this even when it's not relevant
...
- FOR NOW: Do NOT use AI-generated context files â€” they waste money and hurt performance
- If you write a context file, keep it VERY minimal â€” only include essential requirements that the agent absolutely needs to know
...
- Only tested Python repositories â€” other languages might behave differently
- Only measured task completion â€” context files might help in other ways (code quality, security, etc.)
- The AI-generated files were made using current tools â€” better generation methods might work better in the future

## Bottom line in one sentence

Context files are currently overhyped â€” they mostly just make agents do more work and spend more money without solving tasks any better.
